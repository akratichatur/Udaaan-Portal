...
//Members For Today's Transportation Take
        var transportdetailstr1 = 'select * from member inner join transportation on member.udaaan_id=transportation.udaaan_id where transportation.transportation_days_take like "%%%s%"';
...
//Members For Today's Transportation Leave
        var transportdetailstr2 = 'select * from member inner join transportation on member.udaaan_id=transportation.udaaan_id where transportation.transportation_days_leave like "%%%s%"';
